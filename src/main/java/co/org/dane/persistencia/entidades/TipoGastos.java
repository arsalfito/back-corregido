...
public class TipoGastos implements Serializable{
	...
	@Id
	@GeneratedValue( strategy = GenerationType.SEQUENCE, generator = "SeqTipoGastos" )
	@SequenceGenerator( name = "SeqTipoGastos", sequenceName = "SEQ_TIPO_GASTOS", initialValue = 1, allocationSize = 1 )
	@Column( name = "ID_TIPO_GASTO_PK", nullable = false )
	private int id;
