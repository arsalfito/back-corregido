...
import co.org.dane.springjwt.payload.request.LoginRequest;
import co.org.dane.springjwt.payload.request.SignupRequest;
import co.org.dane.springjwt.payload.response.JwtResponse;
import co.org.dane.springjwt.payload.response.MessageResponse;
import co.org.dane.persistencia.repositorios.modulo1.RoleRepository;
import co.org.dane.persistencia.repositorios.modulo1.UserRepository;
import co.org.dane.springjwt.security.jwt.JwtUtils;
import co.org.dane.servicios.jwt.UserDetailsImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		...
		if (strRoles == null) {
			Role userRole = roleRepository.findByName(ERole.Fuente)
